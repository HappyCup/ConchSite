...
(function($, undefined) {
	...
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		this.cssSelector.playlist = this.cssSelector.cssSelectorAncestor +this.cssSelector.playlistCSS+ " .jp-playlist";
		this.cssSelector.next = this.cssSelector.cssSelectorAncestor + " .jp-next";
		this.cssSelector.previous = this.cssSelector.cssSelectorAncestor + " .jp-previous";
		this.cssSelector.shuffle = this.cssSelector.cssSelectorAncestor + " .jp-shuffle";
		this.cssSelector.shuffleOff = this.cssSelector.cssSelectorAncestor + " .jp-shuffle-off";
		this.cssSelector.store=this.cssSelector.cssSelectorAncestor+" div.jp-operation div.jp-store"
		this.cssSelector.share=this.cssSelector.cssSelectorAncestor+" div.jp-operation div.jp-share"
		// Override the cssSelectorAncestor given in options
		this.options.cssSelectorAncestor = this.cssSelector.cssSelectorAncestor;

		// Override the default repeat event handler
		this.options.repeat = function(event) {
			if(currentPlaylist==cssSelector.playlistCSS)
...
//				}
		...
		/*
		$(this.cssSelector.store).click(function() {
			alert("store");
	...
	jPlayerPlaylist.prototype = {
		...
		add: function(media, playNow) {
			for(var p in this.playlist){
				if(this.playlist[p].mp3==media.mp3)
				return false;
			}
		...
		select: function(index) {
			...
			currentPlaylist=this.cssSelector.playlistCSS;
		},
